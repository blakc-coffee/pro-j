                  ...
                  {Platform.OS === 'web' ? (
                    <input
                      ...
                      style={{
                        ...
                        padding: '0 12px',
                        borderRadius: 8,
                        border: `1px solid ${errors.date ? colors.destructive : (colors.inputBorder || colors.border)}`,
                        backgroundColor: colors.input || colors.surfaceAlt,
                  ...
                  {Platform.OS === 'web' ? (
                    <input
                      ...
                      style={{
                        ...
                        padding: '0 12px',
                        borderRadius: 8,
                        border: `1px solid ${errors.time ? colors.destructive : (colors.inputBorder || colors.border)}`,
                        backgroundColor: colors.input || colors.surfaceAlt,
                        color: colors.foreground,
                        fontSize: 14,
                        fontFamily: 'inherit',
